...
/**
 * This class represents/implements a SECSItem with the SECS data type of <code>F8</code>
 * in an array form.
 * In this case it is an array of zero or more 64-bit floating point numbers.  From the Java side this data
...
public class F8ArraySECSItem extends SECSItem
{
    public double[] value = null;
    
    /**
     * This constructor creates a SECSItem that has a type of <code>F8</code> with 
     * the minimum number of length bytes required.
     * <br>
     * Note: It will be created with the number of length bytes required
     * based on the length (in elements) of the <code>double[]</code> provided.
     * The maximum array length allowed is <code>16777215</code> bytes(elements).
     * 
     * @param value an array of Java <code>double</code> to be assigned to this SECSItem
     */
    public F8ArraySECSItem(double[] value)
    {
        super(SECSItemFormatCode.F8, value.length * 8);
        this.value = value;
    }
    
    /**
     * This constructor creates a SECSItem that has a type of <code>F8</code>
     ...
     */
    public F8ArraySECSItem(double[] value, SECSItemNumLengthBytes desiredNumberOfLengthBytes)
    {
        super(SECSItemFormatCode.F8, value.length * 8, desiredNumberOfLengthBytes);
        this.value = value;
    }
     ...
     */
    public F8ArraySECSItem(byte[] data, int itemOffset)
    {
