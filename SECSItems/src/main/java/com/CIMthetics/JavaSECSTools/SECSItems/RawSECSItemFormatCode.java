...
/**
 * This is a helper class that facilitates the mapping/conversion of a SECS
 * message's wire/transmission form of the item format code to/from the Java enum form
 * of the item format code.
 * <p>
 * It was implemented in this manner because in practice the methods provided
 * in this class will be executed an enormous number of times.  In this case
 * efficiency probably needs to actually be considered.
 * <p>
 * The method <code>mapFormatCodeToNumber</code> could have been implemented
 * by assigning values to the enum(s), however in this implementation the
 * values are all in the same place hopefully making maintenance easier.
 * 
 * @author Douglas Kaip
 *
 */
final class RawSECSItemFormatCode
{
...
//    UNDEFINED ( 0x3E );
    ...
    static
    {
        ...
        numberToCodeMap[63] = SECSItemFormatCode.UNDEFINED;
    ...
    /**
     * This method will convert the item format code value that was extracted
     * from a &quot;message&quot; in wire/transmission format to a Java friendly
     * enum.
     * <p>
     ...
     * 
     * @param number the value of the item code extracted from incoming data
     * @return A Java friendly enum form of the number in the raw data.
     */
    protected static SECSItemFormatCode mapNumberToFormatCode(byte number)
    {
        return numberToCodeMap[number];
    }
    
    /**
     * This method will convert an item format code from its Java 
     * frienly enum format into the value required for wire/transmission
     * format.
     * @param itemFormatCode the Java friendly enum format of the SECS item format code to be converted.
     * @return the numeric value of a SECS Item format code in wire/transmission format.
     */
    protected static int mapFormatCodeToNumber(SECSItemFormatCode itemFormatCode)
    {
        return codeToNumberMap[itemFormatCode.ordinal()];
    }
}
