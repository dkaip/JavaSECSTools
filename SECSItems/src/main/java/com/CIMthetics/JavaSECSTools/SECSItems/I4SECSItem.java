...
/**
 * This class represents/implements a <code>SECSItem</code> with the SECS data type of <code>I4</code>,
 * which is a 4 byte (32-bit) signed integer number.  From the Java side this data
 * type is handled as a Java <code>int</code>.
 * 
 * @author Douglas Kaip
 *
 */
public class I4SECSItem extends SECSItem
{
    private int value;
    
    /**
     * This constructor creates a <code>SECSItem</code> that has a type of <code>I4</code> 
     ...
     */
    public I4SECSItem(int value)
    {
        super(SECSItemFormatCode.I4, 4);
        this.value = value;
    }
     ...
     */
    public I4SECSItem(int value, SECSItemNumLengthBytes desiredNumberOfLengthBytes)
    {
        super(SECSItemFormatCode.I4, 4, desiredNumberOfLengthBytes);
        this.value = value;
    }
     ...
     */
    public I4SECSItem(byte[] data, int itemOffset)
    {
