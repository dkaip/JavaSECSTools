...
/**
 * This class represents/implements a SECSItem with the SECS data type of <code>I4</code>
 * in an array form.
 * In this case it is an array of zero or more 32-bit signed integers.  From the Java side this data
...
public class I4ArraySECSItem extends SECSItem
{
    public int[] value = null;
    
    /**
     * This constructor creates a SECSItem that has a type of <code>I4</code> with 
     ...
     */
    public I4ArraySECSItem(int[] value)
    {
        super(SECSItemFormatCode.I4, value.length * 4);
        this.value = value;
    }
     ...
     */
    public I4ArraySECSItem(int[] value, SECSItemNumLengthBytes desiredNumberOfLengthBytes)
    {
        super(SECSItemFormatCode.I4, value.length * 4, desiredNumberOfLengthBytes);
        this.value = value;
    }
     ...
     */
    public I4ArraySECSItem(byte[] data, int itemOffset)
    {
        ...
        value = new int[lengthInBytes / 4];
        for (int i = 0, j = offset; i < value.length; i++, j+= 4)
        {
            value[i] = buf.getInt(j);
        }
    }
